...
function textGenerate() {
    var n = "";
    var text = " Tại vì chị ấm áp hehe :<<<<<<< ";
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho tớ lí do em thích anh đi :vvvv',
        html: true,
        width: 900,
        padding: '3em',
        ...
        confirmButtonText: 'Gửi cho Gumball <3'
    }).then((result) => {
        if (result.value) {
            Swal.fire({
                width: 900,
                ...
                onClose: () => {
                    window.location = 'https://www.facebook.com/boyhandsomedg';
                  }
            })
        }
    })
